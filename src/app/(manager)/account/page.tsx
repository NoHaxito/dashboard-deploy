...
export default async function AccountPage() {
  ...
  return (
    <div className="space-y-3">
      ...
      <section>
        <h3 className="mb-2 text-xl font-bold">Connected accounts</h3>
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-1">
          <div className="bg-neutral-100 rounded-lg px-3 py-2 dark:bg-neutral-900 flex items-center gap-4">
            <svg
              viewBox="0 0 256 250"
              width="256"
              height="250"
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-neutral-500">NoHaxito</span>
              <span className="text-xs text-neutral-500">
                santifeb2034@gmail.com
              </span>
            </div>
          ...
          <div className="bg-neutral-100 rounded-lg px-3 py-2 dark:bg-neutral-900 flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-x-2">
                ...
                <Badge variant="destructive">No connected</Badge>
              </div>
              <span className="text-xs text-neutral-500">----</span>
              <span className="text-xs text-neutral-500">-------</span>
            </div>
            <div className="ml-auto">
              <Button rounded="xl" size="xs">
                Connect
              </Button>
            </div>
          </div>
